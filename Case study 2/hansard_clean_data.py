...
ranges = [([1996, 4, 30], [1997, 4, 30]), #Tony Blair won - Labour
          ([2000, 6, 6], [2001, 6, 6,]), #Tony Blair won - Labour
          ([2004, 5, 4], [2005, 5, 4]), # Tony Blair/Gordon Brown - Labour
          ([2009, 5, 5], [2010, 5, 5]), #David Cameron - Conservative/LibDem
          ([2013, 2, 13], [2014, 2, 13])] #David Cameron - Conservative
